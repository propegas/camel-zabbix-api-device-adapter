...
public class DefaultZabbixApi implements ZabbixApi {
    private final Logger logger = LoggerFactory.getLogger(DefaultZabbixApi.class);
    ...
    private DefaultZabbixApi(URI uri) {
        this.uri = uri;
    }
    ...
    private DefaultZabbixApi(URI uri, CloseableHttpClient httpClient) {
        this(uri);
        this.httpClient = httpClient;
    }
    ...
    public boolean login(String user, String password) {
        ...
        String respAuth = response.getString("result");
        if (respAuth != null && !respAuth.isEmpty()) {
            this.auth = respAuth;
            return true;
        }
        return false;
